define(['dart_sdk', 'packages/angular_router/src/directives/router_outlet_directive', 'packages/angular/src/core/change_detection/change_detection', 'packages/collection/src/comparators'], function(dart_sdk, packages__angular_router__src__directives__router_outlet_directive, packages__angular__src__core__change_detection__change_detection, packages__collection__src__comparators) {
  ...
  dart.defineLazy(CT, {
    ...
    get C6() {
      return C6 = dart.constList([C7 || CT.C7, C10 || CT.C10, C13 || CT.C13, C15 || CT.C15], providers.ClassProvider);
    },
    get C19() {
      return C19 = dart.constList([], module.Module);
    },
    get C18() {
    ...
    get C22() {
      return C22 = dart.wrapType(hash_location_strategy.HashLocationStrategy);
    },
    get C21() {
    ...
    get C20() {
      return C20 = dart.constList([C21 || CT.C21, C10 || CT.C10, C13 || CT.C13, C15 || CT.C15], providers.ClassProvider);
    },
    get C23() {
  ...
  dart.setFieldSignature(router_link_active_directive.RouterLinkActive, () => ({
    ...
    [_routeChanged]: dart.fieldType(async.StreamSubscription$(router_state.RouterState)),
  ...
  let C15;
  let C6;
  const Module_provide = dart.privateName(module, "Module.provide");
  let C19;
  const Module_include = dart.privateName(module, "Module.include");
  let C18;
  let C22;
  let C21;
  let C20;
