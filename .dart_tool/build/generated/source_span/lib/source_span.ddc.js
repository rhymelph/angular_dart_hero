define(['dart_sdk', 'packages/path/path', 'packages/collection/collection', 'packages/term_glyph/src/generated/ascii_glyph_set'], function(dart_sdk, packages__path__path, packages__collection__collection, packages__term_glyph__src__generated__ascii_glyph_set) {
  ...
  location.SourceLocation = class SourceLocation extends core.Object {
    ...
    get toolString() {
      let t4;
      let source = (t4 = this.sourceUrl, t4 == null ? "unknown source" : t4);
  ...
  (location.SourceLocation.new = function(offset, opts) {
    ...
    this[line$] = (t4 = line, t4 == null ? 0 : t4);
    this[column$] = (t4$ = column, t4$ == null ? offset : t4$);
  ...
  highlighter.Highlighter = class Highlighter extends core.Object {
    ...
    [_writeMultilineHighlights](line, highlightsByColumn, opts) {
      ...
      for (let highlight of highlightsByColumn) {
        let startLine = (t5$0 = (t5$ = (t5 = highlight, t5 == null ? null : t5.span), t5$ == null ? null : t5$.start), t5$0 == null ? null : t5$0.line);
        let endLine = (t5$3 = (t5$2 = (t5$1 = highlight, t5$1 == null ? null : t5$1.span), t5$2 == null ? null : t5$2.end), t5$3 == null ? null : t5$3.line);
    ...
    [_writeUnderline](line, span, character) {
      ...
      this[_buffer].write(" "[$times](startColumn));
      this[_buffer].write(character[$times](math.max(core.int, dart.notNull(endColumn) - dart.notNull(startColumn), 1)));
    }
    [_writeArrow](line, column, opts) {
      ...
      t5 = this[_buffer];
      t5.write(top_level.horizontalLine[$times](1 + dart.notNull(column) + dart.notNull(tabs) * (4 - 1)));
      t5.write("^");
      t5;
    }
    [_writeLabel](label) {
    ...
    [_writeSidebar](opts) {
      ...
      if (!(line == null || text == null)) dart.assertFailed(null, "org-dartlang-app:///packages/source_span/src/highlighter.dart", 459, 12, "line == null || text == null");
      if (line != null) text = (dart.notNull(line) + 1)[$toString]();
      this[_colorize](dart.fn(() => {
        let t5, t5$;
        this[_buffer].write((t5 = text, t5 == null ? "" : t5)[$padRight](this[_paddingBeforeSidebar]));
        this[_buffer].write((t5$ = end, t5$ == null ? top_level.verticalLine : t5$));
  ...
  (highlighter.Highlighter.multiple = function(primarySpan, primaryLabel, secondarySpans, opts) {
    ...
    highlighter.Highlighter.__.call(this, highlighter.Highlighter._collateLines((() => {
      let t4 = JSArrayOf_Highlight().of([]);
      t4[$add](new highlighter._Highlight.new(primarySpan, {label: primaryLabel, primary: true}));
      for (let entry of secondarySpans[$entries])
        t4[$add](new highlighter._Highlight.new(entry.key, {label: entry.value}));
      return t4;
    })()), dart.test(color) ? (t5 = primaryColor, t5 == null ? "[31m" : t5) : null, dart.test(color) ? (t5$ = secondaryColor, t5$ == null ? "[34m" : t5$) : null);
  }).prototype = highlighter.Highlighter.prototype;
  ...
  location_mixin.SourceLocationMixin = class SourceLocationMixin extends core.Object {
    get toolString() {
      let t5;
      let source = (t5 = this.sourceUrl, t5 == null ? "unknown source" : t5);
      return dart.str(source) + ":" + dart.str(dart.notNull(this.line) + 1) + ":" + dart.str(dart.notNull(this.column) + 1);
    }
    distance(other) {
      if (!dart.equals(this.sourceUrl, other.sourceUrl)) {
  ...
  span_exception.SourceSpanFormatException = class SourceSpanFormatException extends span_exception.SourceSpanException {
    ...
    get offset() {
      let t5, t5$;
      t5$ = (t5 = this.span, t5 == null ? null : t5.start);
      return t5$ == null ? null : t5$.offset;
    }
  };
  ...
  span_exception.MultiSourceSpanException = class MultiSourceSpanException extends span_exception.SourceSpanException {
    ...
    toString(opts) {
      ...
      return "Error on " + dart.notNull(span['SourceSpanExtension|messageMultiple'](this.span, this.message, this.primaryLabel, this.secondarySpans, {color: useColor, primaryColor: primaryColor, secondaryColor: secondaryColor}));
    }
  };
